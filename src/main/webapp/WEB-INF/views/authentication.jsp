...
<div id="choosePage">
	...
	<div id="logreg">
		<h2>Crear cuenta</h2>
		<a class="social" id="facebook" href="#"><i class="fab fa-facebook-f"></i><span>Registrar</span> con Facebook</a>
<!-- 		<fb:login-button scope="public_profile,email" onlogin="checkLoginState();"> -->
<!-- 		</fb:login-button> -->

		<div id="gSignInWrapper">
			<div id="customBtn" class="customGPlusSignIn">
				<span class="icon fab fa-google"></span><span class="buttonText"><span class="change">Registrar</span> con Google</span>
			</div>
		</div>
	</div>
